...
The definitions for the categories used in classifying the data are outlined below:
...
Follow this link for the definitions for the categories used in classifying the data.
